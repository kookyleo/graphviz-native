...
export async function loadDefaultVizWasmModule(): Promise<VizWasmModule> {
  // Import the compiled Wasm module from @graphviz-anywhere/core
  // This module is generated by emscripten with MODULARIZE=1
  let vizModuleFactory;
  try {
    // Try to import from @kookyleo/graphviz-anywhere-types wasm export first (npm publish case)
    vizModuleFactory = await import('@kookyleo/graphviz-anywhere-types/wasm');
  } catch (error1) {
